                ...
                children: <Widget>[
                                      ...
                                      child: AlertDialog(
                                        ...
                                        actions: <Widget>[
                                          FlatButton(
                                            ...
                                            child: Text(
                                              "Choose Color",
                                              style: TextStyle(fontSize: 18.0, fontFamily: "KoHo", fontWeight: FontWeight.bold),
                                            ),
                                            onPressed: () {
                  ...
                  SizedBox(
                    ...
                    child: RaisedButton(
                      ...
                      child: Text(
                        "Save",
                        style: TextStyle(color: Colors.white,  fontFamily: "KoHo", fontSize: 20.0),
                      ),
                      onPressed: () {
        ...
        child: AlertDialog(
          ...
          actions: <Widget>[
            FlatButton(
              child: Text(
                "Cancel",
                style: TextStyle(fontSize: 17.0, fontFamily: "KoHo"),
              ),
              onPressed: () {
            ...
            FlatButton(
              child: Text("Delete", style: TextStyle(color: Colors.red, fontFamily: "KoHo", fontSize: 17.0)),
              onPressed: callback,
            ),
          ],
        ),
